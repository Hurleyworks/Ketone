...
class OpenglWindow
{
 public:
    ...
    PixelBufferHandle renderImage (PixelBuffer&& pixelBuffer, bool returnRender = false);
 ...
 private:
    ...
    void renderFloatImage (PixelBuffer&& pixelBuffer);

    // handle window events here
    void onWindowFocus (int focused);
    void onWindowResize (int width, int height);
    void onWindowClose();
    PixelBufferHandle getRender (const ImageInfo spec);
