...
struct MotionType
{
    ...
    MotionType (EMotionType name) :
        name (name) {}
    MotionType (unsigned int value) :
        value (value) {}
    MotionType() :
        value (Invalid) {}
...
const bool DEFAULT_RANOOM_INSTANCE_SCALE = true;
const bool DEFAULT_RANDOM_INSTANCE_MATERIAL = true;
